...
public abstract class AbstractJdbc2DatabaseMetaData
{
    ...
    static {
        ...
        String fromTablesFormat = "SELECT NULL as TABLE_CAT, table_schema as TABLE_SCHEM, table_name as TABLE_NAME, type_type as TABLE_TYPE, NULL as REMARKS from information_schema.tables WHERE table_type = '%s'";
        fdbTableTypes.put("TABLE", String.format(fromTablesFormat, "TABLE"));
        fdbTableTypes.put("VIEW", String.format(fromTablesFormat, "VIEW"));
        fdbTableTypes.put("SYSTEM TABLE", String.format(fromTablesFormat, "SYSTEM TABLE"));
        fdbTableTypes.put("SYSTEM VIEW", String.format(fromTablesFormat, "SYSTEM VIEW"));
    ...
    protected java.sql.ResultSet getColumns(int jdbcVersion, String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern) throws SQLException
    {
        ...
        if (connection.isFoundationDBServer()) {
            ...
            if (tableNamePattern != null && !"".equals(tableNamePattern))
            {
                sql += " AND c.table_name LIKE ";
                sql += "'" + connection.escapeString(tableNamePattern) + "'";
            }
    ...
    */
    public java.sql.ResultSet getTablePrivileges(String catalog, String schemaPattern, String tableNamePattern) throws SQLException
    {
        ...
        String sql;
        if (connection.isFoundationDBServer()) {
            sql = "SELECT table_schema as nspname, table_name as relname, " +
                    " table_schema as rolname, null as relacl"+
    ...
    public java.sql.ResultSet getBestRowIdentifier(String catalog, String schema, String table, int scope, boolean nullable) throws SQLException
    {
        ...
        if (connection.isFoundationDBServer()) {
            ...
            sql += "'" + connection.escapeString(table) + "'";
            sql += " ORDER BY ic.ordinal_position";
    ...
    public java.sql.ResultSet getTypeInfo() throws SQLException
    {
        ...
        if (connection.isFoundationDBServer()) {
            sql ="select type_name as typname, postgres_oid as oid from information_schema.types"; 
        } else
        if (connection.haveMinimumServerVersion("7.3"))
        {
    ...
    public java.sql.ResultSet getIndexInfo(String catalog, String schema, String tableName, boolean unique, boolean approximate) throws SQLException
    {
        ...
        if (connection.isFoundationDBServer()) {
            ...
            if (unique)
            {
                sql += " AND i.INDEX_TYPE in ('PRIMARY', 'UNIQUE') ";
            }
            sql += " ORDER BY NON_UNIQUE, TYPE, i.INDEX_NAME, c.ORDINAL_POSITION ";
        } else {
