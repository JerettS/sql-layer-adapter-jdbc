...
public class PGObjectFactory implements ObjectFactory
{
                                    ...
                                    Hashtable environment) throws Exception
    {
        ...
        if (className.equals("com.foundationdb.sql.jdbc.ds.PGSimpleDataSource")
        ...
        else if (className.equals("com.foundationdb.sql.jdbc.ds.PGConnectionPoolDataSource")
        ...
        else if (className.equals("com.foundationdb.sql.jdbc.ds.PGPoolingDataSource")
